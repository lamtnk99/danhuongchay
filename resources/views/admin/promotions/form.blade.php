...
<div class="grid gap-5 lg:grid-cols-2">
    ...
    <div>
        ...
        <input id="badge" name="badge" value="{{ old('badge', $promotion->badge) }}" class="admin-input" placeholder="Ưu đãi tuần này, -15%, Combo mới...">
    ...
    <div>
        ...
        <div class="grid gap-2" data-admin-link-picker>
            ...
            <input id="button_link" name="button_link" value="{{ $buttonLink }}" class="admin-input" placeholder="/thuc-don hoặc https://...">
        </div>
    ...
    <div>
        ...
        <p class="mt-1 text-sm text-slate-500">Trang chủ ưu tiên hiển thị tối đa 4 mục đang bật theo thứ tự sắp xếp.</p>
    ...
    <div @class(['lg:col-span-2', 'hidden' => $selectedPlacement !== 'popup']) data-popup-only>
        ...
        <p class="mt-1 text-sm text-slate-500">Tùy chọn này chỉ áp dụng khi vị trí hiển thị là popup.</p>
    </div>
    <label class="flex items-center gap-2 font-semibold text-slate-700">
